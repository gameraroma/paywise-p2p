...
export function Receipt({ transaction }: ReceiptProps) {
  ...
  return (
    <Card>
      ...
      <CardContent>
        <div ref={receiptRef} className="space-y-4 p-4 bg-white border-2 border-dashed border-neutral-300 rounded-lg">
          <div className="text-center border-b pb-4">
            <h3 className="text-lg font-bold text-green-600">PayWise</h3>
            <p className="text-sm text-neutral-600">Digital Receipt</p>
          </div>
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="flex justify-between">
              <span className="text-neutral-600">{transaction.type === "sent" ? "To:" : "From:"}</span>
              <div className="text-right">
                <p>{transaction.recipientName}</p>
                <p className="text-neutral-500">{transaction.payTag}</p>
              </div>
            </div>
